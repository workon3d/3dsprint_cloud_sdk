...
#include <string>
#include "../TP2_WINCPP_SDK/interop.h"
...
BOOL CTP2_WINCPP_TESTDlg::OnInitDialog()
{
	...
	TeamPlatform::TP2_WINCPP_SDK::PrinterAPI* test = TeamPlatform::TP2_WINCPP_SDK::createPrinterAPI(std::wstring(L"http://192.168.2.21:3000/"));
